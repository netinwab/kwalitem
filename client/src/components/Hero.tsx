      ...
      <section className="relative w-full h-[600px] md:h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight" data-testid="text-hero-headline">
            Elevate Your Brand with Creative Consultant Solutions
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              variant="default"
              asChild
              className="text-base bg-primary text-primary-foreground hover:bg-primary/90 border border-primary/30"
